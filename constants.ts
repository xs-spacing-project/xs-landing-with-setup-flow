...
export const PLAY_STORE_URL = "https://play.google.com/store/apps/details?id=com.xsparking";
export const PLAY_STORE_APP_URL = "market://details?id=com.xsparking";
...
export const FAQ_ITEMS = [
  {
    question: 'How does Xs predict parking rush?',
    answer: 'Xs uses historical data, real-time user traffic, and local event calendars for religious places to forecast rush hours. Our algorithm analyzes patterns to predict high and low traffic times, helping you plan your visit better.',
  },
  {
    question: 'Is my payment secure?',
    answer: 'Absolutely. We use industry-leading payment gateways with end-to-end encryption to ensure that all your transactions are safe and secure.',
  },
  {
    question: 'Can I cancel my booking?',
    answer: 'Yes, you can cancel your booking up to a certain time before your scheduled arrival. Please check the cancellation policy for your specific parking location at the time of booking.',
  },
  {
